  ...
  return (
    <div
      ...
      <div
        ...
        id='blog-post-card'
        className={`group md:h-16 w-full flex justify-between md:flex-row flex-col-reverse ${siteConfig('HEXO_POST_LIST_IMG_CROSSOVER', null, CONFIG) && index % 2 === 1 ? 'md:flex-row-reverse' : ''}
